      ...
      <FAQQuestion open={openQuestions[1]}>
        <Card>
          <CardHeader style={{ padding: 16 }}>
            ...
            <ArrowIcon
              onClick={() =>
                setOpenQuestions({ ...openQuestions, 1: !openQuestions[1] })
              }
              color="white"
              style={{ marginLeft: 'auto' }}
            />
          ...
          <Collapse expanded={openQuestions[1]}>
            <CardBody>
              <p>
                Sim, além do nosso site ser 100% compatível com dispositivos
                móveis teremos também aplicativos nativos para Android e iOS.
              </p>
            </CardBody>
          </Collapse>
        </Card>
